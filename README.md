This is a document to build xorg ports for FreeBSD on
 RaspberryPi
...
"MALLOC_PRODUCTION=yes".if you miss this option, it will
 ...
 assertion). 
if you build your image by crochet-freebsd, you can 
use option "__MAKE_CONF" to specify your make.conf.

2:getting ports tree
you can build image with preinstalled ports tree to use 
...
cause to Segmentation fault (core dumped).
